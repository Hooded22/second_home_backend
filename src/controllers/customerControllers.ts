...
import { validAddCustomerData, validateCustomerAge } from "../validators/customerValidators";

export function validateAddCustomeRequest(req: Request<any, any, ICustomer>, res: Response, next: NextFunction) {
    try {
...
export async function validateUpdateCustomerRequest(req: Request<any, any, Partial<ICustomer>, {id: string}>, res: Response, next: NextFunction) {
    try {
