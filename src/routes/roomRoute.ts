...
roomRouter.post('/', addRoomDataValidation, async (
...
roomRouter.get('/', async (_: Request, res: Response) => {
    try {
...
roomRouter.put("/", updateRoomDataValidation, async (req: Request<any, any, Partial<IRoom>, {id: string}>, res: Response) => {
    try {
